...
First, we introduce an indicator function $I^{(i)}(x)$ which marks pixels for 2D
and voxels for 3D digitized images as belonging to the phase $i$ or not. It can
be defined so:
\begin{equation*}
  I^{(i)}(x) = \left\{
  \begin{array}{ll}
...
\Cref{fig:sobel-vs-distance-map} shows a different picture:
