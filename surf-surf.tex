...
%     FIG.1. A schematic depiction of a binary porous media (pores are shown in color) with
%examples of positive events for surface FSS, FSV and two-point probability S2 correlation functions.
%The zoomed in area represents the difference between the true “continuous” interface in between
%pore and solid phases with pixelized “digital” interface emerging due to limited resolution of digital
%images.
