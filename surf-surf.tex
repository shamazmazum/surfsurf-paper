...
\cref{sec:comparison}. \textcolor{red}{FIXME: Update links and text.} For the
images of Poisson disks from \cref{fig:scaling} their discretizations and
$C_{0.5}$ are shown in \cref{fig:disks-noise}. We immediately observe that the
...
\cref{fig:scaling} and \cref{fig:disks-noise} we can claim that the criterion
