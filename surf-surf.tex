...
technically infinity. While surface function is well defined at $r=0$, it
differs from $S_2$ in two significant aspects -- it mostly resembles two-point
cross-correlation function (as instead of autocorrelation we have to compute
correlation between the interface and the void phase), plus during computation
of such ``cross-correlations'' one has to keep in mind that
